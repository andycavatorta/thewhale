...
class Main(threading.Thread):
    ...
    def get_sdc_runtime_status(self):
        ...
        return {
            ...
            "encoder_speed_relative_2":self.sdc.motor_2.get_encoder_speed_relative(),
            ...
            try:
                ...
                if topic==b"request_motor_speed":
                    if destination == self.rotor_name[0]:
                        ...
                        self.sdc.motor_1.go_to_speed_or_relative_position(message)
                        status = self.sdc.motor_1.get_motor_command_applied()
                    ...
                    if destination == self.rotor_name[1]:
                        ...
                        self.sdc.motor_2.go_to_speed_or_relative_position(message)
                        status = self.sdc.motor_2.get_motor_command_applied()
