...
class SDCRow{
  constructor(hostname, rotor1name, rotor2name, y_position_1, y_position_2
    ...
    this.duty_cycle_1 = new Block_Display_Text(this.dom_parent, [block_grid_x[8],y_position_1], "", 80)
    this.duty_cycle_2 = new Block_Display_Text(this.dom_parent, [block_grid_x[8],y_position_2], "", 80)
    this.closed_loop_error_1 = new Block_Display_Text(this.dom_parent, [block_grid_x[9],y_position_1], "", 80)
    this.closed_loop_error_2 = new Block_Display_Text(this.dom_parent, [block_grid_x[9],y_position_2], "", 80)
    ...
    this.pid_proportional_gain_motor1 = new Block_Display_Text(this.dom_parent, [block_grid_x[11],y_position_1], "", 60)
    this.pid_proportional_gain_motor2 = new Block_Display_Text(this.dom_parent, [block_grid_x[11],y_position_2], "", 60)
